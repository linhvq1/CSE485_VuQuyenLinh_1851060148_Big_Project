...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 18, 2021 lúc 01:51 AM
...
CREATE TABLE `achievement` (
  `id_achi` int(11) NOT NULL,
  `id_a` int(11) DEFAULT NULL,
  `name_achi` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `icon_achi` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `achievement` (`id_achi`, `id_a`, `name_achi`, `icon_achi`, `label`) VALUES
(1, 1, '3 Years', 'fa fa-award', 'Work Experiences'),
(2, 1, '30 Clients', 'fa fa-users', 'Satisfied'),
(3, 1, '15 Projects', 'fa fa-check-circle', 'Delivered'),
(4, 1, '10 Avaiable', 'fa fa-wrench', 'For Hire'),
(5, 1, '8 Language', 'fas fa-laptop-code', 'Learn tools'),
(7, 1, 'Full Stack Web', 'fas fa-layer-group', 'professionally');
...
(6, 1, 'Student', '2001-06-01', '2005-08-05', 'Nam Dinh', 'studied at here');
...
(8, 1, 'beer', 'fas fa-beer', 'oh my godness!! it so crazy ! :))');
...
(1, 1, 1, 'Stargazer Workshop portfo', '60047708b178f7.82486754.jpg', 'https://filiprastovic.github.io/stargazerworkshop-freelancer-landing-page/'),
...
(4, 1, 3, 'Adrien Loret', 'Adrien Loret.jfif', 'https://www.adrienloret.fr/'),
(5, 1, 1, 'Chris Tammar', 'Chris Tammar.jfif', 'https://www.christammar.com/'),
(6, 1, 2, 'Made Architects', 'Made Architects.jfif', 'https://www.made-studio.es/'),
(21, 1, 3, 'boostrap 5', '6004d2c7a2ba78.35377963.jpg', 'https://getbootstrap.com/docs/5.0/components/collapse/');
...
CREATE TABLE `skill` (
  ...
  `background` enum('info','primary','secondary','success','danger','warning','light','dark','White','Muted') COLLATE utf8_unicode_ci NOT NULL,
  `detail` text COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `skill` (`id_s`, `id_a`, `name_s`, `type`, `icon_s`, `progress`, `background`, `detail`) VALUES
(1, 1, 'OutSystems', 'Programming', 'fab fa-ubuntu', 85, 'success', 'The System Information app provides detailed specifications and other information about your Mac hardware and software, including your network and external devices. In some versions of OS X, this app is called System Profiler.'),
(2, 1, 'MEAN Stack', 'Searching', 'fab fa-stack-overflow', 75, 'primary', 'Stack Overflow is the largest, most trusted online community for developers to learn, share their knowledge, and build their careers. More than 50 million professional and aspiring programmers visit Stack Overflow each month to help solve coding problems, develop new skills, and find job opportunities.'),
(3, 1, 'C#/C++', 'Programming', 'fab fa-windows', 70, 'secondary', 'At a very basic level, both C# and C++ have similar code. C# is much newer to the game, however. ... Both C++ and C# are object-oriented languages, although C++ is considered a harder language to work with. Both of them can be used in web and desktop applications, but C# is much more popular now for both applications and everything'),
(4, 1, 'HTML5 &amp; CSS', 'Programming', 'fab fa-html5', 65, 'warning', 'HTML (the Hypertext Markup Language) and CSS (Cascading Style Sheets) are two of the core technologies for building Web pages. HTML provides the structure of the page, CSS the (visual and aural) layout, for a variety of devices. Along with graphics and scripting, HTML and CSS are the basis of building Web pages and Web Applications.\r\n\r\nCSS is the language for describing the presentation of Web pages, including colors, layout, and fonts. It allows one to adapt the presentation to different types of devices, such as large screens, small screens, or printers. CSS is independent of HTML and can be used with any XML-based markup language. The separation of HTML from CSS makes it easier to maintain sites, share style sheets across pages, and tailor pages to different environments. This is referred to as the separation of structure (or: content) from presentation.'),
(5, 1, 'Python', 'Programming', 'fab fa-python', 80, 'danger', 'It is used for:\r\n\r\nweb development (server-side),\r\nsoftware development,\r\nmathematics,\r\nsystem scripting.'),
(6, 1, 'Java', 'Programming', 'fab fa-java', 85, 'primary', 'Java is a class-based, object-oriented programming language that is designed to have as few implementation dependencies as possible.'),
(8, 1, 'Data Mining', 'Research', 'fas fa-brain', 70, 'warning', 'Big data');
...
(6, 1, 'Twitter', 'https://twitter.com/?lang=vi', 'fab fa-twitter-square');
...
--
ALTER TABLE `achievement`
  MODIFY `id_achi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `experience`
--
ALTER TABLE `experience`
  MODIFY `id_e` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `social_media`
  MODIFY `id_so` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT cho bảng `type_portfolio`
--
ALTER TABLE `type_portfolio`
...
--
ALTER TABLE `achievement`
  ADD CONSTRAINT `achievement_ibfk_1` FOREIGN KEY (`id_a`) REFERENCES `admin` (`id_a`);
...
--
ALTER TABLE `portfolio`
  ADD CONSTRAINT `portfolio_ibfk_1` FOREIGN KEY (`id_a`) REFERENCES `admin` (`id_a`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `portfolio_ibfk_2` FOREIGN KEY (`id_t`) REFERENCES `type_portfolio` (`id_t`) ON DELETE CASCADE ON UPDATE CASCADE;
